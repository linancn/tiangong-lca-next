    ...
    contactDataSet: {
      ...
      contactInformation: {
        dataSetInformation: {
          ...
          "referenceToContact": {
            "@refObjectId": data?.contactInformation?.dataSetInformation?.referenceToContact?.['@refObjectId'],
            ...
            "common:shortDescription": getLangJson(
              data?.contactInformation?.dataSetInformation?.referenceToContact?.['common:shortDescription'],
            ),
            '@version': data?.contactInformation?.dataSetInformation?.referenceToContact?.['@version'],
          }
        }
      },
