    ...
    flowDataSet: {
      ...
      flowInformation: {
        dataSetInformation: {
          ...
          "common:synonyms": getLangJson(data?.flowInformation?.dataSetInformation?.["common:synonyms"]),
          classificationInformation: {
            'common:elementaryFlowCategorization': {
              'common:category': classificationToList(data?.flowInformation?.dataSetInformation?.classificationInformation?.['common:elementaryFlowCategorization']?.['common:category']),
            },
          },
          "CASNumber": data?.flowInformation?.dataSetInformation?.["CASNumber"],
          'common:generalComment': getLangJson(data?.flowInformation?.dataSetInformation?.["common:generalComment"]),
          "common:other": {
            "ecn:ECNumber": data?.flowInformation?.dataSetInformation?.["common:other"]?.["ecn:ECNumber"],
          }
        },
      ...
      flowProperties: {
        flowProperty: {
          ...
          referenceToFlowPropertyDataSet: {
            ...
            "common:shortDescription": getLangJson(data?.flowProperties?.flowProperty?.referenceToFlowPropertyDataSet?.["common:shortDescription"])
          },
  ...
  return removeEmptyObjects({
    flowInformation: {
      dataSetInformation: {
        ...
        "common:synonyms": getLangList(data?.flowInformation?.dataSetInformation?.["common:synonyms"]),
        classificationInformation: {
          'common:elementaryFlowCategorization': {
            'common:category': classificationToJson(data?.flowInformation?.dataSetInformation?.classificationInformation?.['common:elementaryFlowCategorization']?.['common:category']),
          },
        },
        "CASNumber": data?.flowInformation?.dataSetInformation?.["CASNumber"],
        'common:generalComment': getLangList(data?.flowInformation?.dataSetInformation?.["common:generalComment"]),
        "common:other": {
          "ecn:ECNumber": data?.flowInformation?.dataSetInformation?.["common:other"]?.["ecn:ECNumber"],
        }
      },
    ...
    flowProperties: {
      flowProperty: {
        ...
        referenceToFlowPropertyDataSet: {
          ...
          "@type": data?.flowProperties?.flowProperty?.referenceToFlowPropertyDataSet?.["@type"],
          "@uri": data?.flowProperties?.flowProperty?.referenceToFlowPropertyDataSet?.["@uri"],
          "common:shortDescription": getLangList(data?.flowProperties?.flowProperty?.referenceToFlowPropertyDataSet?.["common:shortDescription"])
        },
        "meanValue": data?.flowProperties?.flowProperty?.["meanValue"],
      }
    }
