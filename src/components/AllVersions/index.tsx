...
const AllVersionsList: FC<AllVersionsListProps> = ({ searchTableName, id,children }) => {
    ...
    return (
        ...
        />
            ...
            <Tooltip title={<FormattedMessage id="pages.button.allVersion" defaultMessage="All version" />}>
                <Button size='small' shape='circle' icon={<UnorderedListOutlined />} onClick={() => setShowAllVersionsModal(true)}>
                </Button>
            </Tooltip>
