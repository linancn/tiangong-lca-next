...
const TableList: FC = () => {
    ...
    if (pathname === '/manageWelcomeTeams') { // Manage teams on homepage
        teamColumns.push({
            ...
            render: (_, record) => (
                <Input
                    ...
                    onPressEnter={(e:any) => {
                        ...
                        Modal.confirm({
                            title: intl.formatMessage({ id: 'component.allTeams.table.confirm', defaultMessage: 'Confirm to modify the rank?' }),
                            onOk: async () => {
                                try {
