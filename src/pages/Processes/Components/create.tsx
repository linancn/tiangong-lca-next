...
const ProcessCreate: FC<CreateProps> = ({ lang, actionRef,actionType='create',id,version }) => {
  ...
  return (
    <>
      ...
      <Drawer
        ...
        title={
          <FormattedMessage
            id={actionType==='copy'?'pages.button.copy':actionType==='createVersion'?"pages.button.createVersion":"pages.button.create"}
