import { Button, Drawer, Tooltip, Space, message, Spin } from 'antd';
...
export default function SelectReviewer({ reviewIds, actionRef }: SelectReviewerProps) {
    ...
    return <>
        <Tooltip title={<FormattedMessage id='pages.review.selectReviewer.button' defaultMessage='Select Reviewer' />}>
            <Button onClick={() => setDrawerVisible(true)} type='text' icon={<AuditOutlined />} size='small' />
        </Tooltip>
