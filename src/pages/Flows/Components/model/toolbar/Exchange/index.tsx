...
const EdgeExhange: FC<Props> = ({ lang, disabled, edge, nodes, onData }) => {
    ...
    const onCreateData = (data: any) => {
        const newData = {
            ...
            sourceOutputFlowName: data?.selectedSource?.referenceToFlowDataSet?.['common:shortDescription'],
    ...
    const edgeExhangeColumns: ProColumns<EdgeExchangeTable>[] = [
        ...
        {
            title: <FormattedMessage id="pages.table.title.sourceOutputFlowName" defaultMessage="Source Output Flow Name" />,
        ...
        {
            title: (
                <FormattedMessage id="pages.table.title.targetInputFlowName" defaultMessage="Target Input Flow Name" />
            ),
    ...
    return (
        <>
            ...
            ></FormattedMessage>}
                placement="left">
                <Button shape="circle" size="small" icon={<ArrowRightOutlined />} disabled={disabled} onClick={onOpenDrawer} />
            </Tooltip>

            <Drawer
                title={
                    <FormattedMessage id="pages.flow.model.edge.exchange.drawer.title.list" defaultMessage="Edge Exchange List" />
                }
                width="90%"
                closable={false}
                extra={
