...
const EdgeExhange: FC<Props> = ({ lang, disabled, edge, nodes, readonly, onData }) => {
    ...
    const edgeExhangeColumns: ProColumns<EdgeExchangeTable>[] = [
        ...
        },
        {
            title: (
                <FormattedMessage
                    id="pages.table.title.sourceOutputFlowName"
        ...
        },
        {
            title: (
                <FormattedMessage
                    id="pages.table.title.targetInputFlowName"
                ...
                return [
                    <Space size={'small'} key={0}>
                        ...
                        <Tooltip title={<FormattedMessage id="pages.button.delete" defaultMessage="Delete" />}>
                            <Button shape="circle" icon={<DeleteOutlined />} size="small" onClick={() => { onDeleteData(row.id) }} />
                        </Tooltip>
                    </Space>,
                ];
            },
    ...
    return (
        <>
            ...
            <Drawer
                title={
                    <FormattedMessage
                        id="pages.flow.model.edge.exchange.drawer.title.list"
                        defaultMessage="Edge Exchange List"
                    />
                }
                width="90%"
                closable={false}
