...
const ModelToolbarInfo: FC<Props> = ({ data, onData }) => {
    ...
    return (
        <>
            <Tooltip
                title={
                    <FormattedMessage id="pages.button.info" defaultMessage="Base Infomation" />
                }
                placement="left"
            >
                <Button
                ...
                >
                    <Space direction="vertical" style={{ width: '100%' }}>
                        ...
                        <Card size="small" title={'Name'}>
                            <LangTextItemFrom name={['productInformation', 'dataSetInformation', 'name']} label={'Name'} />
                        </Card>
                        <Card size="small" title={'General Comment'}>
                            <LangTextItemFrom name={['productInformation', 'dataSetInformation', 'common:generalComment']} label={'General Comment'} />
                        </Card>
                    </Space>
                </ProForm>
                <Collapse
