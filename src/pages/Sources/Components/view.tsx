            ...
            setViewDescriptions(
                <>
                    ...
                    <Descriptions bordered size={'small'} column={1}>
                        ...
                        <Descriptions.Item key={0} label="SourceCitation" labelStyle={{ width: '100px' }}>
                            {result.data.sourceCitation ?? '-'}
                        </Descriptions.Item>
                        <Descriptions.Item key={0} label="PublicationType" labelStyle={{ width: '100px' }}>
                            {result.data.publicationType ?? '-'}
                        </Descriptions.Item>
