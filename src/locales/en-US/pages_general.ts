export default {
  ...
  'pages.validationIssues.sdkDetail.suggestedFix.quantitative_reference_count_invalid': 'The following data must have exactly one item designated as the reference',
