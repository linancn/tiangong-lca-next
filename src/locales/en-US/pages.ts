export default {
  ...
  'pages.login.password.forgot.success': 'The email was sent successfully! Please follow the email link to reset your password.',
  ...
  'pages.login.signUp.success': 'The email has been sent successfully. Please check your inbox and follow the link to complete the process.',
