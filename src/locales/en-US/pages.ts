export default {
  ...
  'pages.dataProcessing.tabs.builds': 'Build Requests',
  'pages.dataProcessing.tabs.preview': 'Package Preview',
  'pages.dataProcessing.tabs.publication': 'Publication',
  'pages.dataProcessing.form.packageName': 'Package name',
  ...
  'pages.dataProcessing.form.previewPackageId': 'Preview package id',
  'pages.dataProcessing.form.publishPackageId': 'Publish package id',
  ...
  'pages.dataProcessing.action.createBuild': 'Create build',
  'pages.dataProcessing.action.previewPackage': 'Preview package',
  'pages.dataProcessing.action.publishPackage': 'Publish package',
  ...
  'pages.dataProcessing.command.createBuildSuccess': 'Build request submitted',
  'pages.dataProcessing.command.previewPackageSuccess': 'Package preview loaded',
  'pages.dataProcessing.command.publishPackageSuccess': 'Package published',
  'pages.dataProcessing.command.unpublishPublicationSuccess': 'Publication unpublished',
  'pages.dataProcessing.command.buildId': 'Build ID',
  'pages.dataProcessing.command.workerJobId': 'Worker job',
  'pages.dataProcessing.command.packageId': 'Package ID',
  'pages.dataProcessing.command.packageVersion': 'Package version',
  'pages.dataProcessing.command.publicationId': 'Publication ID',
  'pages.dataProcessing.command.status': 'Status',
  'pages.dataProcessing.validation.packageNameRequired': 'Package name is required',
  'pages.dataProcessing.validation.packageIdRequired': 'Package id is required',
  ...
  'pages.dataProcessing.jobs.title': 'Package build jobs',
