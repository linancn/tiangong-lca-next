export default {
  ...
  'validator.StringMultiLang.empty':
    'It is recommended to fill in to ensure data completeness and accuracy!',
  'validator.StringMultiLang.length500': 'Length cannot exceed 500 characters!',
  'validator.STMultiLang.empty':
    'It is recommended to fill in to ensure data completeness and accuracy!',
  'validator.STMultiLang.length1000': 'Length cannot exceed 1000 characters!',
  'validator.CASNumber.empty':
  ...
  'validator.pages.contact.email.empty': 'Email is optional!',
  'validator.pages.contact.email.pattern': 'The input is not valid E-mail!',
  'validator.pages.contact.WWWAddress.empty ': 'WWWAddress is optional!',
