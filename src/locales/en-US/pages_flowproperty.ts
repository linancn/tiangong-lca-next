export default {
  ...
  'pages.FlowProperties.view.flowPropertiesInformation.generalComment':
    'General comment on data set',
  'pages.FlowProperties.view.flowPropertiesInformation.classification': 'Classification',
  'pages.FlowProperties.view.modellingAndValidation.referenceToComplianceSystem':
    'Compliance system name',
  'pages.FlowProperties.view.modellingAndValidation.approvalOfOverallCompliance':
  ...
  'pages.FlowProperties.view.modellingAndValidation.publicationAndOwnership':
  ...
  'pages.flowproperties.deleteMessage.areyousureyouwanttodeletethisdata?':
    'Are you sure you want to delete this data?',
  'pages.FlowProperties.view.flowPropertiesInformation.quantitativeReference':
