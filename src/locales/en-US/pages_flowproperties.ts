export default {
  'pages.flowproperties.name': 'Data Name',
  'pages.flowproperties.classification': 'Classification',
  'pages.flowproperties.createdAt': 'Created At',
  'pages.flowproperties.generalComment': 'General Comment',
