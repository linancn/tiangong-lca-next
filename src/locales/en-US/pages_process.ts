export default {
  'pages.process.referenceYear': 'Year',
  ...
  'pages.process.exchange.dataDerivationTypeStatus': 'Data Derivation Type',
  ...
  'pages.process.view.processInformation.Geography:locationOfOperationSupplyOrProduction':
    'Geography:Location of operation supply or production',
  'pages.process.view.processInformation.location': 'Location',
  'pages.process.view.processInformation.descriptionOfRestrictions': 'Description of restrictions',
  'pages.process.view.processInformation.technology': 'Technology',
  ...
  'pages.process.view.processInformation.technologicalApplicability': 'Technological applicability',
  ...
  'pages.process.view.exchanges': 'Exchanges',
