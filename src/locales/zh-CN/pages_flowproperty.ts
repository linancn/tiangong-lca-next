export default {
  'pages.flowproperty.referenceToReferenceUnitGroup': '参考单位组引用',
  ...
  'pages.flowpropertiy.generalComment': '概述',
  ...
  'pages.FlowProperties.view.modellingAndValidation.timeStamp': '时间戳',
  'pages.FlowProperties.view.modellingAndValidation.referenceToDataSetFormat': '参考数据集格式',
