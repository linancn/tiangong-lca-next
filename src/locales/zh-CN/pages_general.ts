export default {
  ...
  'pages.validationIssues.sdkDetail.suggestedFix.quantitative_reference_count_invalid': '以下数据中必须有且仅有一个基准流',
  ...
  'pages.validationIssues.sdkDetail.suggestedFix.custom': '请检查并补充此项',
  'pages.validationIssues.sdkDetail.suggestedFix.unknown': '请检查并补充此项',
