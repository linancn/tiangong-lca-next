export default {
  ...
  'pages.process.exchange.drawer.title.create': '创建流',
  'pages.process.exchange.drawer.title.view': '查看流',
  'pages.process.exchange.drawer.title.edit': '编辑流',
  ...
  'pages.process.view.processInformation.Geography:locationOfOperationSupplyOrProduction':
    '地理位置：运营、供应或生产地点',
  ...
  'pages.process.view.modellingAndValidation.completeness:CompletenessDescription':
    '完整性：完整性描述',
  ...
  'pages.process.view.administrativeInformation.dataEntryBy:TimeStamp': '数据输入者：时间戳',
  ...
  'pages.process.view.exchange.referenceToReferenceFlow': '参考流引用',
