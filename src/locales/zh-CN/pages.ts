export default {
  ...
  'pages.dataProcessing.command.createBuildSuccess': '构建请求已提交',
  'pages.dataProcessing.command.previewPackageSuccess': '包预览已加载',
  'pages.dataProcessing.command.publishPackageSuccess': '包已发布',
  'pages.dataProcessing.command.unpublishPublicationSuccess': '发布已下架',
  'pages.dataProcessing.command.buildId': '构建 ID',
  'pages.dataProcessing.command.workerJobId': 'Worker 任务',
  'pages.dataProcessing.command.packageId': '包 ID',
  'pages.dataProcessing.command.packageVersion': '包版本',
  'pages.dataProcessing.command.publicationId': '发布 ID',
  'pages.dataProcessing.command.status': '状态',
  'pages.dataProcessing.validation.packageNameRequired': '请输入包名称',
  'pages.dataProcessing.validation.packageIdRequired': '请输入包 ID',
