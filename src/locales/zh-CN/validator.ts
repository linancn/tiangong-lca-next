export default {
  ...
  'validator.StringMultiLang.empty': '建议填写，以确保数据完整性和准确性！',
  'validator.StringMultiLang.length500': '长度不能超过500个字符！',
  'validator.STMultiLang.empty': '建议填写，以确保数据完整性和准确性！',
  'validator.STMultiLang.length1000': '长度不能超过1000个字符！',
