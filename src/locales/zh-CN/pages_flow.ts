export default {
  ...
  'pages.flow.model.drawer.title.edge.exchange.select': '选择流连接桩',
  ...
  'pages.flow.view.administrativeInformation.referenceToPersonOrEntityEnteringTheData': '数据输入方式:',
  'pages.flow.view.administrativeInformation.referenceToOwnershipOfDataSet': '数据集的所有者',
