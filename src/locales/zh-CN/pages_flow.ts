export default {
  ...
  'pages.flow.view.flowInformation.generalComment':'总评',
  'pages.flow.view.flowInformation.eCNumber':'EC登记号',
  'pages.flow.view.modellingAndValidation.lCIMethod:TypeOfDataSet':'LCI方法:数据集类型',
  'pages.flow.view.modellingAndValidation.complianceDeclarations':'完整性声明',
  'pages.flow.view.modellingAndValidation.referenceToComplianceSystem':'完整性系统的引用',
  'pages.flow.view.modellingAndValidation.approvalOfOverallCompliance':'整体完整性批准',
  'pages.flow.view.administrativeInformation.dataEntryBy':'数据输入方式',
  'pages.flow.view.administrativeInformation.timeStamp':'时间点',
  'pages.flow.view.administrativeInformation.referenceToDataSetFormat':'数据集格式的引用',
