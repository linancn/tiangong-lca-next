...
lastReviewedNote: 'Reviewed for Next Issue #820: stable dataset submission carries no Gate assertion, while the Review Admin diagnostic uses a separate authenticated Edge boundary.'
---
