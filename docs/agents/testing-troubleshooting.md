...
lastReviewedNote: 'Reviewed for Issue #703: the v0.0.62 promote-only package metadata leaves existing main-candidate, immutable-tag, and managed-push recovery guidance sufficient.'
---
