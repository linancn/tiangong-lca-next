...
lastReviewedNote: 'Reviewed for project-path prefixing of existing classification and location runtime assets; language capability, provenance, and fallback rules remain unchanged.'
