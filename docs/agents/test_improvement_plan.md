...
lastReviewedNote: 'Reviewed for Next #999: exact model-version, null fallback, navigation, listing, and child-result cases close through the existing strategy without a new queue or browser matrix.'
---
