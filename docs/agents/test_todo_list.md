...
lastReviewedNote: 'Reviewed for Next Issue #982: the Process sort now matches its exact descending RPC contract and qualification continuation retains mode/proof identity; no testing queue is open.'
---
