...
lastReviewedNote: 'Reviewed for the #698 pre-promotion main-to-dev back-merge: retain #690 detached-CI locale-artifact parity, the later workspace-owned capture boundary, and the empty ordered coverage queue.'
---
