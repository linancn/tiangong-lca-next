...
lastReviewedNote: 'Reviewed for Next Issue #982: Process sorting, toolbar geometry, qualification continuation, and Jest 30 browser-global compatibility are closed; no testing queue is open.'
---
