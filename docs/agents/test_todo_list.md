...
lastReviewedNote: 'Reviewed for the 2026-09-03 dependency refresh: the exact toolchain and compatible package lines advance without reopening the coverage queue; final proof remains the managed push gate.'
---
...
- The 2026-09-03 dependency refresh advances the exact toolchain to Node `24.20.0` and pnpm `11.25.0`, updates the compatible direct graph to Umi `4.7.12`, Jest `30.5.1`, Electron `44.1.1`, Supabase JS `2.114.0`, Oxlint `1.81.0`, Testing Library user-event `14.6.7`, and React DOM types `19.2.7`, while preserving TypeScript `7.0.2`, React `19.2.8`, TIDAS SDK `0.2.0`, and the Node-24 `@types/node@24.13.3` line. The existing package identity, start, build, service, and full-coverage gates remain the acceptance surface; no new coverage queue is opened.
