...
lastReviewedNote: 'Reviewed Calculation Bundle and Release read UI proof: typed service contracts stay fully covered while hook-heavy read panels use focused behavior tests plus the final full gate.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
