...
lastReviewedNote: 'Reviewed for Issue #745 Root/Reference Review UI: add focused proof for seven-type submission, simple decisions, root-child presentation, and owner notification routing while retaining the managed full gate.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
