...
lastReviewedNote: 'Reviewed for Issue #685: main-target PRs and main-semantic local pushes now fail closed on production readiness, and release tags are published only after both exact-release gates pass.'
related:
  - ../AGENTS.md
  - ../.docpact/config.yaml
