// @ts-nocheck
import { NodeComponentCard } from '@/pages/Review/Components/reviewLifeCycleModels/Components/toolbar/config/node';
...
describe('ReviewLifeCycleModelNodeComponentCard', () => {
