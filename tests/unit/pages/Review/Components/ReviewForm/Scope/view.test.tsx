// @ts-nocheck
import ScopeItemView from '@/pages/Review/Components/ReviewForm/Scope/view';
...
describe('ReviewFormScopeView', () => {
  it('renders mapped scope and method labels and preserves raw values when unmapped', () => {
    render(
      <ScopeItemView
        data={[
          {
