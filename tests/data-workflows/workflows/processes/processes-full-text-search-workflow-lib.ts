...
Usage:
  pnpm test:workflows --processes:full-text-search --frontend-url http://127.0.0.1:8000 --supabase-url https://submidrhbtknjxfympna.supabase.co
  pnpm test:workflows --processes:full-text-search --detail-result --no-keep-data
