...
lastReviewedNote: 'Updated for Issue #670 on current dev: documented the isolated docs screenshot capture command, secret file, and denial evidence without changing the release bootstrap.'
---
