...
lastReviewedCommit: 41177c7afe388aeb7b4be4e9948524616f436e96
...
| verify an external semantic-evidence artifact is in canonical repository format | `npm run i18n:evidence:canonical:check -- --path <artifact>` |
