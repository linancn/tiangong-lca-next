...
lastReviewedNote: 'Updated for Issue #670: documented the isolated docs screenshot capture command, secret file, and denial evidence.'
---
...
- a capture plan may navigate, click, wait, assert, and apply explicitly read-only filters; the browser guard aborts other POST/PUT/PATCH/DELETE requests except the declared authentication/session exchange
